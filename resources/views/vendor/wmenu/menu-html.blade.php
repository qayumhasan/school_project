															...
															<div class="customlinkdiv" id="customlinkdiv">
																...
																<p id="menu-item-url-wrap">
																	<div class="form-group">
																		...
																		<select class="form-control" id="menu_cat">
																			<option disabled selected>Select Menu
																				Category</option>
																...
																<p id="menu-item-url-wrap hidden">
																	...
																	<input id="custom-menu-item-url" name="url"
																		type="hidden" class="menu-item-textbox "
																		placeholder="url">
																	</label>
																</p>
												...
												<div id="nav-menu-header">
													<div class="major-publishing-actions">
														<label class="menu-name-label howto open-label" for="menu-name">
															<b><span>Edit
																	<u>@if(isset($indmenu)){{$indmenu->name}}@endif</u>
																	Section Menu:</span></b>
												...
												<div id="nav-menu-footer">
													<div class="major-publishing-actions">
														...
														<a onclick="getmenus()" name="save_menu" id="save_menu_header"
															class="button button-primary menu-save my-4">Save menu</a>
														<div class="publishing-action">
								...
								<div class="row">
									...
									<div class="col-lg-6">
										...
										<ul class="menu ui-sortable" id="menu-to-edit">
											...
											<li id="menu-item"
												class="menu-item menu-item-depth menu-item-page menu-item-edit-inactive pending"
												style="display: list-item;">
												<dl class="menu-item-bar">
													<dt class="menu-item-handle" style="width: 100%">
														<span class="item-title"> <span class="menu-item-title"> <span
																	id="menutitletemp_vfdssd">{{ $menu['label'] }}</span>
																<span style="color: transparent;"></span> </span> <span
																class="is-submenu">Main Menu</span> </span>
														<span class="item-controls"> </span> <a class="item-edit"
															id="edit" title=" " href=""> </a> </span>
													</dt>
												</dl>
												...
												<dl class="menu-item-bar">
													...
													<dt class="menu-item-handle"
														style="margin-left: 50px;width:80%;margin-top:5px">
														<span class="item-title"> <span class="menu-item-title"> <span
																	id="menutitletemp_vfdssd">{{ $child['label'] }}</span>
																<span style="color: transparent;"></span> </span> <span
																class="is-submenu">Sub Menu</span> </span>
														<span class="item-controls"> </span> <a class="item-edit"
															id="edit" title=" " href=""> </a> </span>
													</dt>
													@endforeach
