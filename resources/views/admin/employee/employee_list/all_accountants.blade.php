                            ...
                            <tr class="text-center">
                                ...
                                <td>
                                    @if (json_decode($userPermits->employee_module, true)['edit'] == 1) 
                                        @if($accountant['employee_status']==1)
                                        <a href="{{ route('admin.employee.status.update', $accountant['id'] ) }}" class="btn btn-success btn-sm ">
                                            <i class="fas fa-thumbs-up"></i></a>
                                        @else
                                        <a href="{{ route('admin.employee.status.update', $accountant['id'] ) }}" class="btn btn-danger btn-sm">
