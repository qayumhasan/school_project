            ...
            <div class="panel_header">
                <div class="row">
                    ...
                    <div class="col-md-6 text-right">
                        <div class="panel_title">
                            @if (json_decode($userPermits->income_module, true)['income_header']['add'] == 1)
                                <a href="#" class="btn btn-sm btn-success" data-toggle="modal" data-target="#myModal1">
                                    <i class="fas fa-plus"></i></span> <span>Add Income Header</span>
                                </a>
                            @endif
                        </div>
                    </div>
                        ...
                        <table id="dataTableExample1" class="table table-bordered table-striped table-hover mb-2">
                            ...
                            <tbody>
                                ...
                                <tr class="text-center">
                                    ...
                                    @endif
                                    <td>
                                        @if (json_decode($userPermits->income_module, true)['income_header']['edit'] == 1)
                                            @if($header->status==1)
                                        ...
                                        @if (json_decode($userPermits->income_module, true)['income_header']['delete'] == 1)    
