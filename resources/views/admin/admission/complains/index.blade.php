            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="panel_title">
                        <span class="panel_icon"><i class="fas fa-border-all"></i></span><span>Complain</span>
                    </div>
                </div>
                <div class="col-md-6 text-right">
                    <div class="panel_title">
                        <a href="#" class="btn btn-sm btn-success" data-toggle="modal" data-target="#myModal1"><i class="fas fa-plus"></i></span> <span>Add Complain</span></a>
                    </div>
                </div>
            </div>
        </div>
        <form action="{{route('admin.complaint.multi.delete')}}" method="post">
            @csrf
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @if($row->status == 1)
                                    <a href="{{ route('admin.complaint.status', $row->id) }}" class="btn btn-success btn-sm ">
                                        <i class="fas fa-thumbs-up"></i></a>

                                    @else
                                    <a href="{{ route('admin.complaint.status', $row->id ) }}" class="btn btn-danger btn-sm">
                                ...
                                <td>
                                    <a class="view_route btn btn-sm btn-blue text-white" data-action="{{route('admin.complaint.view',$row->id)}}" data-id="{{$row->id}}" title="edit" data-toggle="modal" data-target="#viewmodal"><i class="fa fa-eye" aria-hidden="true"></i></a>
                                    | <a class="edit_route btn btn-sm btn-blue text-white" data-action="{{route('admin.complaint.edit',$row->id)}}" data-id="{{$row->id}}" title="edit" data-toggle="modal" data-target="#editModal"><i class="fas fa-pencil-alt"></i></a> |
                                    <a id="delete" href="{{route('admin.complaint.delete',$row->id)}}" class="btn btn-danger btn-sm text-white" title="Delete">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" action="{{ route('admin.complaint.store') }}" enctype="multipart/form-data" method="POST">
                    @csrf
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            ...
                            <input type="text" class="form-control form-control -sm" placeholder="Enter Complainer Name" name="complain_by" required />
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            ...
                            <textarea class="form-control form-control -sm" placeholder="Enter Description" name="details"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            ...
                            <input type="text" class="form-control form-control -sm" placeholder="Enter Action Taken" name="action_taken" required />
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            ...
                            <input type="text" class="form-control form-control -sm" placeholder="Enter Assigned" name="assigned" required />
                        </div>
                    </div>
...
<div class="modal fade" id="viewmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">View Complain</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
